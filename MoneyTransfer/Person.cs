...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine($"{this.name} currently has ${this.wallet.money}");
        }
        ...
        public bool TransferMoney(Person receiver, int amountToTransfer)
        {
            ...
            Console.WriteLine($"{this.name} is attempting to transfer money to {receiver.name}");
            ...
            else if (amountToTransfer > this.wallet.money)
            {
